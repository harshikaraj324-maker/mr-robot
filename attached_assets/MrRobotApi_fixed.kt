...
class MrRobotApi(private val context: Context) {
    ...
    companion object {
        ...
        // ── Proxy relay URL (real backend URL is hidden server-side) ──────
        const val API_BASE_URL = "https://6077107f-a39e-40c6-b43b-7ae50c0ae048-00-30ffsrnvv20y1.pike.replit.dev/api/relay"
        ...
        withContext(Dispatchers.IO) {
            suspendCancellableCoroutine { cont ->
                ...
                val request = Request.Builder()
                    ...
                    .addHeader(SECRET_HDR, APP_SECRET)          // ← FIX
